...
popup = {
    window: {
        ...
        followTimer: function() {
            ...
            console.log(timerWindow.getBounds().left + timerWindow.getBounds().width);
            appWindow.moveTo(timerWindow.getBounds().left + timerWindow.getBounds().width, timerWindow.getBounds().top);
            console.log('POPUP: MOVEDDDDDDD');
        },
        loadTasks: function() {
